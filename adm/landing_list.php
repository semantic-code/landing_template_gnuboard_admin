...
<div class="local_ov01 local_ov">
    <span class="btn_ov01"><span class="ov_txt">등록된 랜딩페이지 목록</span></span>
</div>

<div class="btn_fixed_top">
    <a href="./landing_form.php" class="btn btn_01">랜딩 추가</a>
</div>
        ...
        <?php foreach ($list as $i => $row): ?>
            ...
            <tr>
                ...
                <td style="display: flex; justify-content: center; gap: .7rem;">
                    <a href="./landing_preview.php?ld_page=<?=$row['ld_page']?>" class="btn btn_01" onclick="return open_preview(this.href);">미리보기</a>
                    <a href="./landing_form.php?w=u&ld_page=<?php echo $row['ld_page']; ?>" class="btn btn_02">수정</a>
                    <a href="./landing_list_update.php?w=d&ld_page=<?php echo $row['ld_page']; ?>" class="btn btn_03" onclick="return confirm('정말 삭제하시겠습니까?');">삭제</a>
                </td>
            </tr>
        <?php  endforeach; ?>
        <?php else: ?>

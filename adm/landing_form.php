    ...
    <div class="tbl_frm01 tbl_wrap">
        <table>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="ld_page" id="ld_page" value="<?php echo $landing['ld_page'] ?? time(); ?>" required class="frm_input" size="30" >
                    <button type="button" class="btn btn_02" id="btn_id_check" style="margin-left: .5rem;">중복확인</button>
                    <span class="frm_info">URL 식별자 (예: landing.php?ld_page=여기에 입력한 값)</span>
                </td>
            </tr>
            <tr>
            ...
            <tr style="">
                <th scope="row"><label for="ld_content">내용(이미지/HTML)</label></th>
...
<script>
    function on_submit(f){
        ...
        <?php echo chk_editor_js('ld_content', true);?>
